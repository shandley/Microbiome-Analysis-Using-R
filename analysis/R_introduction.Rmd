...
1. How do you filter to just taxa that appeared in more than one sample
(prevalence >= 2)?
...
1. Try different distances for `plot_network`
1. Try different values of special arguments in the above.
